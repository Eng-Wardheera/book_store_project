...
const AddBook = () => {
    ...
    const { data, error} = useFetchAllCategoriesQuery();
  ...
  return (
    <div className="max-w-lg   mx-auto md:p-6 p-3 bg-white rounded-lg shadow-md">
      ...
      <SelectField
        ...
        options={
          data
            ? [{ value: '', label: 'Choose a category' }, ...data.map(category => ({
                value: (category.name || category.catName)?.toLowerCase() || "", 
                label: category.name || category.catName 
              }))]
